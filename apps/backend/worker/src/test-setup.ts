...
// Mirrors apps/backend/api/src/test-setup.ts. Without this, worker unit tests
// only passed locally because dotenv loaded the developer's `.env`; in CI (no
// .env) `@hsm/config` threw "ENVIRONMENT is required".
